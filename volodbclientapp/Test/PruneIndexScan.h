...
#ifndef __DistributedKeyValueStore__PruneIndexScanTest__
#define __DistributedKeyValueStore__PruneIndexScanTest__
...
template<class T1>
class PruneIndexScan : public BasicTest<T1, shared_ptr< ::google::protobuf::Message>>, public TaskOperations<shared_ptr< ::google::protobuf::Message>>
{
    
public:
    PruneIndexScan(const string& name): BasicTest<T1, shared_ptr< ::google::protobuf::Message>>(name, this){}
    /*
...
#endif /* defined(__DistributedKeyValueStore__PruneIndexScanTest__) */
