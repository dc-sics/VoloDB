...
${OBJECTDIR}/AttributeUtils/ColumnsValueBuilder.o: AttributeUtils/ColumnsValueBuilder.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AttributeUtils/ColumnsValueBuilder.o AttributeUtils/ColumnsValueBuilder.cpp

${OBJECTDIR}/AttributeUtils/ColumnsValueDecoder.o: AttributeUtils/ColumnsValueDecoder.cpp 
	${MKDIR} -p ${OBJECTDIR}/AttributeUtils
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AttributeUtils/ColumnsValueDecoder.o AttributeUtils/ColumnsValueDecoder.cpp

${OBJECTDIR}/Config/ConfigFileReader.o: Config/ConfigFileReader.cpp 
	${MKDIR} -p ${OBJECTDIR}/Config
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Config/ConfigFileReader.o Config/ConfigFileReader.cpp

${OBJECTDIR}/Frame/FrameBuilder.o: Frame/FrameBuilder.cpp 
	${MKDIR} -p ${OBJECTDIR}/Frame
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Frame/FrameBuilder.o Frame/FrameBuilder.cpp

${OBJECTDIR}/Frame/FrameDecoder.o: Frame/FrameDecoder.cpp 
	${MKDIR} -p ${OBJECTDIR}/Frame
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Frame/FrameDecoder.o Frame/FrameDecoder.cpp

${OBJECTDIR}/Frame/FrameUtils.o: Frame/FrameUtils.cpp 
	${MKDIR} -p ${OBJECTDIR}/Frame
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Frame/FrameUtils.o Frame/FrameUtils.cpp

${OBJECTDIR}/OperationUtils/OperationUtils.o: OperationUtils/OperationUtils.cpp 
	${MKDIR} -p ${OBJECTDIR}/OperationUtils
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OperationUtils/OperationUtils.o OperationUtils/OperationUtils.cpp

${OBJECTDIR}/ProtoBuf/Column.pb.o: ProtoBuf/Column.pb.cc 
	${MKDIR} -p ${OBJECTDIR}/ProtoBuf
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ProtoBuf/Column.pb.o ProtoBuf/Column.pb.cc

${OBJECTDIR}/ProtoBuf/DefinitionOperation.pb.o: ProtoBuf/DefinitionOperation.pb.cc 
	${MKDIR} -p ${OBJECTDIR}/ProtoBuf
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ProtoBuf/DefinitionOperation.pb.o ProtoBuf/DefinitionOperation.pb.cc

${OBJECTDIR}/ProtoBuf/Filter.pb.o: ProtoBuf/Filter.pb.cc 
	${MKDIR} -p ${OBJECTDIR}/ProtoBuf
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ProtoBuf/Filter.pb.o ProtoBuf/Filter.pb.cc

${OBJECTDIR}/ProtoBuf/Frame.pb.o: ProtoBuf/Frame.pb.cc 
	${MKDIR} -p ${OBJECTDIR}/ProtoBuf
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ProtoBuf/Frame.pb.o ProtoBuf/Frame.pb.cc

${OBJECTDIR}/ProtoBuf/ManipulationOperations.pb.o: ProtoBuf/ManipulationOperations.pb.cc 
	${MKDIR} -p ${OBJECTDIR}/ProtoBuf
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ProtoBuf/ManipulationOperations.pb.o ProtoBuf/ManipulationOperations.pb.cc

${OBJECTDIR}/ProtoBuf/Operation.pb.o: ProtoBuf/Operation.pb.cc 
	${MKDIR} -p ${OBJECTDIR}/ProtoBuf
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ProtoBuf/Operation.pb.o ProtoBuf/Operation.pb.cc

${OBJECTDIR}/ProtoBuf/Result.pb.o: ProtoBuf/Result.pb.cc 
	${MKDIR} -p ${OBJECTDIR}/ProtoBuf
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ProtoBuf/Result.pb.o ProtoBuf/Result.pb.cc

${OBJECTDIR}/Test/TestBase.o: Test/TestBase.cpp 
	${MKDIR} -p ${OBJECTDIR}/Test
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Test/TestBase.o Test/TestBase.cpp

${OBJECTDIR}/Utils/Utils.o: Utils/Utils.cpp 
	${MKDIR} -p ${OBJECTDIR}/Utils
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Utils/Utils.o Utils/Utils.cpp
